...
def demonstrate_integer():
    ...
    my_integer = 6# Assign any integer value to 'my_integer'
    return my_integer
...
def demonstrate_float():
    ...
    my_float = 6.3#ssign any floating-point value to 'my_float'
    return my_float
...
def demonstrate_boolean():
    ...
    my_boolean =True#ssign either True or False to 'my_boolean'
    return my_boolean
...
def demonstrate_variable_scope():
    ...
    """
    This function demonstratelement1,element2,element3es variable scope in Python.
